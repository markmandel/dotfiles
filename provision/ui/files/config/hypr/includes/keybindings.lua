...
hl.bind(
    mainMod .. " + SHIFT + equal",
    layout_bind({
        ["lua:columns"] = hl.dsp.layout("reset"),
...
hl.bind(
    ...
    layout_bind({
        ...
        ["lua:columns"] = hl.dsp.layout("swapwithmaster")
    })
)
...
hl.bind("XF86AudioRaiseVolume", hl
    .dsp
    .exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ 0 && wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"), {
    locked = true,
    repeating = true
})
